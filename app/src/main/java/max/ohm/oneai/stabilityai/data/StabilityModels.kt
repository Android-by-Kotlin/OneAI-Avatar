...
data class StructureControlRequest(
    val image: String, // Base64 encoded or file path
    val prompt: String,
    val controlStrength: Float = 0.7f,
    val outputFormat: String = "webp"
...
data class StructureControlResponse(
    val status: String? = null,
    val imageData: ByteArray? = null,
    val error: String? = null,
    val message: String? = null
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as StructureControlResponse
...
data class StyleControlRequest(
    val image: String, // Base64 encoded or file path
    val prompt: String,
    val outputFormat: String = "webp"
)

data class StyleControlResponse(
    val status: String? = null,
    val imageData: ByteArray? = null,
    val error: String? = null,
    val message: String? = null
