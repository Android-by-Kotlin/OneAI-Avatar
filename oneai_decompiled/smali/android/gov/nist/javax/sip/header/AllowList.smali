...
.method public clone()Ljava/lang/Object;
    ...
    .line 54
    .local v0, "retval":Landroid/gov/nist/javax/sip/header/AllowList;
    iget-object v1, p0, Landroid/gov/nist/javax/sip/header/AllowList;->hlist:Ljava/util/List;

    invoke-virtual {v0, v1}, Landroid/gov/nist/javax/sip/header/AllowList;->clonehlist(Ljava/util/List;)Landroid/gov/nist/javax/sip/header/SIPHeaderList;
...
.method public getMethods()Ljava/util/ListIterator;
    ...
    .local v1, "it":Ljava/util/Iterator;, "Ljava/util/Iterator<Landroid/gov/nist/javax/sip/header/Allow;>;"
    :goto_0
    ...
    .line 84
    .local v2, "a":Landroid/gov/nist/javax/sip/header/Allow;
    ...
    .line 85
    .end local v2    # "a":Landroid/gov/nist/javax/sip/header/Allow;
    goto :goto_0

    .line 87
    .end local v1    # "it":Ljava/util/Iterator;, "Ljava/util/Iterator<Landroid/gov/nist/javax/sip/header/Allow;>;"
    :cond_0
...
.method public setMethods(Ljava/util/List;)V
    ...
    .line 108
    new-instance v1, Landroid/gov/nist/javax/sip/header/Allow;

    invoke-direct {v1}, Landroid/gov/nist/javax/sip/header/Allow;-><init>()V

    .line 109
    .local v1, "allow":Landroid/gov/nist/javax/sip/header/Allow;
    ...
    invoke-virtual {v1, v2}, Landroid/gov/nist/javax/sip/header/Allow;->setMethod(Ljava/lang/String;)V

    .line 110
    invoke-virtual {p0, v1}, Landroid/gov/nist/javax/sip/header/AllowList;->add(Landroid/gov/nist/javax/sip/header/SIPHeader;)Z

    .line 111
    .end local v1    # "allow":Landroid/gov/nist/javax/sip/header/Allow;
    goto :goto_0
