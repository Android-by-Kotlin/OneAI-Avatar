...
.method public static final PredictiveBackHandler(ZLkotlin/jvm/functions/Function2;Landroidx/compose/runtime/Composer;II)V
    ...
    invoke-static {v3}, Landroidx/activity/compose/PredictiveBackHandlerKt;->PredictiveBackHandler$lambda$0(Landroidx/compose/runtime/State;)Lkotlin/jvm/functions/Function2;

    move-result-object v8

    invoke-direct {v15, v6, v7, v8}, Landroidx/activity/compose/PredictiveBackHandlerCallback;-><init>(ZLkotlinx/coroutines/CoroutineScope;Lkotlin/jvm/functions/Function2;)V
    ...
    .local v8, "backCallBack":Landroidx/activity/compose/PredictiveBackHandlerCallback;
    invoke-static {v4}, Landroidx/compose/runtime/ComposerKt;->sourceInformationMarkerEnd(Landroidx/compose/runtime/Composer;)V
    ...
    invoke-virtual {v8, v10}, Landroidx/activity/compose/PredictiveBackHandlerCallback;->setCurrentOnBack(Lkotlin/jvm/functions/Function2;)V

    .line 89
    invoke-virtual {v8, v7}, Landroidx/activity/compose/PredictiveBackHandlerCallback;->setOnBackScope(Lkotlinx/coroutines/CoroutineScope;)V
    ...
    .restart local v3    # "currentOnBack$delegate":Landroidx/compose/runtime/State;
    :cond_10
    move-object/from16 p2, v3
    ...
    .line 92
    .local v3, "$i$a$-cache-PredictiveBackHandlerKt$PredictiveBackHandler$2":I
    move/from16 v16, v3

    .end local v3    # "$i$a$-cache-PredictiveBackHandlerKt$PredictiveBackHandler$2":I
    ...
    invoke-direct {v3, v8, v6, v7}, Landroidx/activity/compose/PredictiveBackHandlerKt$PredictiveBackHandler$2$1;-><init>(Landroidx/activity/compose/PredictiveBackHandlerCallback;ZLkotlin/coroutines/Continuation;)V
    ...
    invoke-static {v10, v3, v4, v7}, Landroidx/compose/runtime/EffectsKt;->LaunchedEffect(Ljava/lang/Object;Lkotlin/jvm/functions/Function2;Landroidx/compose/runtime/Composer;I)V
    ...
    invoke-virtual {v3, v4, v7}, Landroidx/activity/compose/LocalOnBackPressedDispatcherOwner;->getCurrent(Landroidx/compose/runtime/Composer;I)Landroidx/activity/OnBackPressedDispatcherOwner;
    ...
    .line 101
    .local v3, "backDispatcher":Landroidx/activity/OnBackPressedDispatcher;
    ...
    invoke-direct {v15, v3, v7, v8}, Landroidx/activity/compose/PredictiveBackHandlerKt$PredictiveBackHandler$3$1;-><init>(Landroidx/activity/OnBackPressedDispatcher;Landroidx/lifecycle/LifecycleOwner;Landroidx/activity/compose/PredictiveBackHandlerCallback;)V
    ...
    invoke-static {v7, v3, v14, v4, v9}, Landroidx/compose/runtime/EffectsKt;->DisposableEffect(Ljava/lang/Object;Ljava/lang/Object;Lkotlin/jvm/functions/Function1;Landroidx/compose/runtime/Composer;I)V
    ...
    .line 108
    .end local v3    # "backDispatcher":Landroidx/activity/OnBackPressedDispatcher;
    .end local v7    # "lifecycleOwner":Landroidx/lifecycle/LifecycleOwner;
    .end local v8    # "backCallBack":Landroidx/activity/compose/PredictiveBackHandlerCallback;
    ...
    invoke-direct {v7, v6, v0, v1, v2}, Landroidx/activity/compose/PredictiveBackHandlerKt$PredictiveBackHandler$4;-><init>(ZLkotlin/jvm/functions/Function2;II)V
    ...
    .line 95
    .restart local v8    # "backCallBack":Landroidx/activity/compose/PredictiveBackHandlerCallback;
