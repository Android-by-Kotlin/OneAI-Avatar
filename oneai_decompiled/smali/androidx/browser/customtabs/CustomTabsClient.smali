...
.method public static getPackageName(Landroid/content/Context;Ljava/util/List;Z)Ljava/lang/String;
    ...
    const-string/jumbo v5, "android.support.customtabs.action.CustomTabsService"
    ...
    const-string/jumbo v5, "Unable to find any Custom Tabs packages, you may need to add a <queries> element to your manifest. See the docs for CustomTabsClient#getPackageName."
...
.method private newSessionInternal(Landroidx/browser/customtabs/CustomTabsCallback;Landroid/app/PendingIntent;)Landroidx/browser/customtabs/CustomTabsSession;
    ...
    const-string/jumbo v3, "android.support.customtabs.extra.SESSION_ID"
