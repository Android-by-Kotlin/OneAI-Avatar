...
.method public static final mutableScatterSetOf(Ljava/lang/Object;)Landroidx/collection/MutableScatterSet;
    .locals 3
    .param p0, "element1"    # Ljava/lang/Object;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<E:",
            "Ljava/lang/Object;",
    ...
    .local v1, "$this$mutableScatterSetOf_u24lambda_u241":Landroidx/collection/MutableScatterSet;
    const/4 v2, 0x0

    .line 88
    .local v2, "$i$a$-apply-ScatterSetKt$mutableScatterSetOf$1":I
    ...
    .line 87
    .end local v1    # "$this$mutableScatterSetOf_u24lambda_u241":Landroidx/collection/MutableScatterSet;
    .end local v2    # "$i$a$-apply-ScatterSetKt$mutableScatterSetOf$1":I
    nop
...
.method public static final mutableScatterSetOf(Ljava/lang/Object;Ljava/lang/Object;)Landroidx/collection/MutableScatterSet;
    .locals 3
    .param p0, "element1"    # Ljava/lang/Object;
    .param p1, "element2"    # Ljava/lang/Object;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<E:",
            "Ljava/lang/Object;",
    ...
    .local v1, "$this$mutableScatterSetOf_u24lambda_u242":Landroidx/collection/MutableScatterSet;
    const/4 v2, 0x0

    .line 96
    .local v2, "$i$a$-apply-ScatterSetKt$mutableScatterSetOf$2":I
    invoke-virtual {v1, p0}, Landroidx/collection/MutableScatterSet;->plusAssign(Ljava/lang/Object;)V
    ...
    .line 95
    .end local v1    # "$this$mutableScatterSetOf_u24lambda_u242":Landroidx/collection/MutableScatterSet;
    .end local v2    # "$i$a$-apply-ScatterSetKt$mutableScatterSetOf$2":I
    nop
...
.method public static final mutableScatterSetOf(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Landroidx/collection/MutableScatterSet;
    ...
    .param p0, "element1"    # Ljava/lang/Object;
    .param p1, "element2"    # Ljava/lang/Object;
    .param p2, "element3"    # Ljava/lang/Object;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<E:",
            "Ljava/lang/Object;",
    ...
    .local v1, "$this$mutableScatterSetOf_u24lambda_u243":Landroidx/collection/MutableScatterSet;
    const/4 v2, 0x0

    .line 105
    .local v2, "$i$a$-apply-ScatterSetKt$mutableScatterSetOf$3":I
    invoke-virtual {v1, p0}, Landroidx/collection/MutableScatterSet;->plusAssign(Ljava/lang/Object;)V
    ...
    .line 104
    .end local v1    # "$this$mutableScatterSetOf_u24lambda_u243":Landroidx/collection/MutableScatterSet;
    .end local v2    # "$i$a$-apply-ScatterSetKt$mutableScatterSetOf$3":I
    nop
...
.method public static final varargs mutableScatterSetOf([Ljava/lang/Object;)Landroidx/collection/MutableScatterSet;
    ...
    .line 1101
    .local v1, "$this$mutableScatterSetOf_u24lambda_u244":Landroidx/collection/MutableScatterSet;
    const/4 v2, 0x0

    .line 114
    .local v2, "$i$a$-apply-ScatterSetKt$mutableScatterSetOf$4":I
    invoke-virtual {v1, p0}, Landroidx/collection/MutableScatterSet;->plusAssign([Ljava/lang/Object;)V

    .end local v1    # "$this$mutableScatterSetOf_u24lambda_u244":Landroidx/collection/MutableScatterSet;
    .end local v2    # "$i$a$-apply-ScatterSetKt$mutableScatterSetOf$4":I
    return-object v0
.end method
...
.method public static final varargs scatterSetOf([Ljava/lang/Object;)Landroidx/collection/ScatterSet;
    ...
    .line 1101
    .local v1, "$this$scatterSetOf_u24lambda_u240":Landroidx/collection/MutableScatterSet;
    const/4 v2, 0x0

    .line 76
    .local v2, "$i$a$-apply-ScatterSetKt$scatterSetOf$1":I
    invoke-virtual {v1, p0}, Landroidx/collection/MutableScatterSet;->plusAssign([Ljava/lang/Object;)V

    .end local v1    # "$this$scatterSetOf_u24lambda_u240":Landroidx/collection/MutableScatterSet;
    .end local v2    # "$i$a$-apply-ScatterSetKt$scatterSetOf$1":I
    check-cast v0, Landroidx/collection/ScatterSet;
