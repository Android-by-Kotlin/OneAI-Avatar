...
.method public static final AndroidEmbeddedExternalSurface-sv6N_fY(Landroidx/compose/ui/Modifier;ZJ[FLkotlin/jvm/functions/Function1;Landroidx/compose/runtime/Composer;II)V
    ...
    const-string v1, "C(AndroidEmbeddedExternalSurface)P(1!1,3:c#ui.unit.IntSize,4:c#ui.graphics.Matrix)455@18917L45,457@18968L796:AndroidExternalSurface.android.kt#71ulvw"
    ...
    .restart local p2    # "surfaceSize":J
    :cond_14
    move-wide v4, v6

    .line 452
    .end local p2    # "surfaceSize":J
    .restart local v4    # "surfaceSize":J
    :goto_c
    if-eqz v8, :cond_15
    ...
    .local v6, "transform":[F
    goto :goto_d

    .line 452
    .end local v6    # "transform":[F
    ...
    const-string/jumbo v2, "androidx.compose.foundation.AndroidEmbeddedExternalSurface (AndroidExternalSurface.android.kt:454)"
    ...
    invoke-static {v11, v0}, Landroidx/compose/foundation/AndroidExternalSurface_androidKt;->rememberAndroidEmbeddedExternalSurfaceState(Landroidx/compose/runtime/Composer;I)Landroidx/compose/foundation/AndroidEmbeddedExternalSurfaceState;

    move-result-object v0

    .line 458
    .local v0, "state":Landroidx/compose/foundation/AndroidEmbeddedExternalSurfaceState;
    new-instance v1, Landroidx/compose/foundation/AndroidExternalSurface_androidKt$AndroidEmbeddedExternalSurface$1;

    invoke-direct {v1, v0, v14, v15, v9}, Landroidx/compose/foundation/AndroidExternalSurface_androidKt$AndroidEmbeddedExternalSurface$1;-><init>(Landroidx/compose/foundation/AndroidEmbeddedExternalSurfaceState;JLkotlin/jvm/functions/Function1;)V
    ...
    .line 458
    sget-object v1, Landroidx/compose/foundation/AndroidExternalSurface_androidKt$AndroidEmbeddedExternalSurface$2;->INSTANCE:Landroidx/compose/foundation/AndroidExternalSurface_androidKt$AndroidEmbeddedExternalSurface$2;

    move-object/from16 v17, v1

    check-cast v17, Lkotlin/jvm/functions/Function1;

    new-instance v18, Landroidx/compose/foundation/AndroidExternalSurface_androidKt$AndroidEmbeddedExternalSurface$3;
    ...
    invoke-direct/range {v1 .. v6}, Landroidx/compose/foundation/AndroidExternalSurface_androidKt$AndroidEmbeddedExternalSurface$3;-><init>(JLandroidx/compose/foundation/AndroidEmbeddedExternalSurfaceState;Z[F)V
    ...
    new-instance v18, Landroidx/compose/foundation/AndroidExternalSurface_androidKt$AndroidEmbeddedExternalSurface$4;
...
.method public static final AndroidExternalSurface-58FFMhA(Landroidx/compose/ui/Modifier;ZJIZLkotlin/jvm/functions/Function1;Landroidx/compose/runtime/Composer;II)V
    ...
    const-string v1, "C(AndroidExternalSurface)P(2!1,4:c#ui.unit.IntSize,5:c#foundation.AndroidExternalSurfaceZOrder)288@12167L37,290@12210L1032:AndroidExternalSurface.android.kt#71ulvw"
    ...
    const-string/jumbo v2, "androidx.compose.foundation.AndroidExternalSurface (AndroidExternalSurface.android.kt:287)"
    ...
    invoke-static {v12, v1}, Landroidx/compose/foundation/AndroidExternalSurface_androidKt;->rememberAndroidExternalSurfaceState(Landroidx/compose/runtime/Composer;I)Landroidx/compose/foundation/AndroidExternalSurfaceState;

    move-result-object v6

    .line 291
    .local v6, "state":Landroidx/compose/foundation/AndroidExternalSurfaceState;
    new-instance v1, Landroidx/compose/foundation/AndroidExternalSurface_androidKt$AndroidExternalSurface$1;

    invoke-direct {v1, v10, v6}, Landroidx/compose/foundation/AndroidExternalSurface_androidKt$AndroidExternalSurface$1;-><init>(Lkotlin/jvm/functions/Function1;Landroidx/compose/foundation/AndroidExternalSurfaceState;)V
    ...
    .line 291
    sget-object v2, Landroidx/compose/foundation/AndroidExternalSurface_androidKt$AndroidExternalSurface$2;->INSTANCE:Landroidx/compose/foundation/AndroidExternalSurface_androidKt$AndroidExternalSurface$2;
    ...
    .line 300
    .local v2, "$i$a$-cache-AndroidExternalSurface_androidKt$AndroidExternalSurface$3":I
    ...
    .line 505
    .end local v2    # "$i$a$-cache-AndroidExternalSurface_androidKt$AndroidExternalSurface$3":I
    ...
    .end local v6    # "state":Landroidx/compose/foundation/AndroidExternalSurfaceState;
    .local v16, "state":Landroidx/compose/foundation/AndroidExternalSurfaceState;
    move-object v6, v12
    ...
    .line 324
    .end local v16    # "state":Landroidx/compose/foundation/AndroidExternalSurfaceState;
    :cond_1f
    move/from16 v17, v15
    ...
    new-instance v20, Landroidx/compose/foundation/AndroidExternalSurface_androidKt$AndroidExternalSurface$4;
...
.method private static final rememberAndroidEmbeddedExternalSurfaceState(Landroidx/compose/runtime/Composer;I)Landroidx/compose/foundation/AndroidEmbeddedExternalSurfaceState;
    ...
    const-string v2, "C(rememberAndroidEmbeddedExternalSurfaceState)384@15036L24,385@15072L55:AndroidExternalSurface.android.kt#71ulvw"
    ...
    const-string/jumbo v3, "androidx.compose.foundation.rememberAndroidEmbeddedExternalSurfaceState (AndroidExternalSurface.android.kt:383)"
    ...
    invoke-direct {v1, v8}, Landroidx/compose/runtime/CompositionScopedCoroutineScopeCanceller;-><init>(Lkotlinx/coroutines/CoroutineScope;)V
    ...
    .line 386
    .local v10, "$i$a$-remember-AndroidExternalSurface_androidKt$rememberAndroidEmbeddedExternalSurfaceState$1":I
    new-instance v11, Landroidx/compose/foundation/AndroidEmbeddedExternalSurfaceState;

    invoke-direct {v11, v1}, Landroidx/compose/foundation/AndroidEmbeddedExternalSurfaceState;-><init>(Lkotlinx/coroutines/CoroutineScope;)V

    .line 527
    .end local v10    # "$i$a$-remember-AndroidExternalSurface_androidKt$rememberAndroidEmbeddedExternalSurfaceState$1":I
    move-object v10, v11
    ...
    check-cast v10, Landroidx/compose/foundation/AndroidEmbeddedExternalSurfaceState;
...
.method private static final rememberAndroidExternalSurfaceState(Landroidx/compose/runtime/Composer;I)Landroidx/compose/foundation/AndroidExternalSurfaceState;
    ...
    const-string v2, "C(rememberAndroidExternalSurfaceState)190@7150L24,191@7186L47:AndroidExternalSurface.android.kt#71ulvw"
    ...
    const-string/jumbo v3, "androidx.compose.foundation.rememberAndroidExternalSurfaceState (AndroidExternalSurface.android.kt:189)"
    ...
    .line 192
    .local v10, "$i$a$-remember-AndroidExternalSurface_androidKt$rememberAndroidExternalSurfaceState$1":I
    new-instance v11, Landroidx/compose/foundation/AndroidExternalSurfaceState;

    invoke-direct {v11, v1}, Landroidx/compose/foundation/AndroidExternalSurfaceState;-><init>(Lkotlinx/coroutines/CoroutineScope;)V

    .line 499
    .end local v10    # "$i$a$-remember-AndroidExternalSurface_androidKt$rememberAndroidExternalSurfaceState$1":I
    move-object v10, v11
    ...
    .end local v2    # "$changed$iv":I
    .end local v3    # "$i$f$remember":I
    check-cast v10, Landroidx/compose/foundation/AndroidExternalSurfaceState;
